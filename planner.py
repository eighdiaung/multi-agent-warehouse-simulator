class Planner:
    ...
    def update_task_progress(self, robot):
        ...
        if task is not None:
            ...
            elif robot.position == task["dropoff"] and task["status"] == "picked up":
    ...
    def get_valid_moves_for_robot(self, robot):
    ...
    def rank_candidate_moves(self, robot):
        valid_moves = self.get_valid_moves_for_robot(robot)
    ...
    def choose_best_move(self, robot):
        ranked_moves = self.rank_candidate_moves(robot)
